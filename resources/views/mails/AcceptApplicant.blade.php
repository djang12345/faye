...
<body>
    <div class="container">
        ...
        <p>
            Date: <strong>{{ Carbon\Carbon::parse($application->interview_date)->format('F j, Y') }}</strong><br>
            Time: <strong>{{ Carbon\Carbon::parse($application->interview_time)->format('g:i A') }}</strong>
        </p>
