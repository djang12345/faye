                    ...
                    <div class="p-6">
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <InputLabel for="user_id" value="Select Employee" class="flex items-center">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">
                                        ...
                                        Select the employee for whom you're creating this payroll record
                                    </p>
                                </div>
                                <div v-if="selectedEmployee" class="bg-blue-50 p-4 rounded-lg">
                                    <div class="flex items-center">
                                        <i class="bx bx-info-circle text-blue-600 mr-2"></i>
                                        <div>
                                            <p class="font-semibold text-blue-900">Selected Employee</p>
                                            <p class="text-blue-700">{{ selectedEmployee.name }}</p>
                                            <p class="text-sm text-blue-600">{{ selectedEmployee.email }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div class="mt-3 space-y-3">
                                    ...
                                    <div class="bg-gray-100 p-3 rounded-lg">
                                        ...
                                        <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                                            <button 
                                                ...
                                                @click="setCurrentMonthFirstHalf"
                                            >
                                                1st Half (Current)
                                            </button>
                                            <button 
                                                ...
                                                @click="setCurrentMonthSecondHalf"
                                            >
                                                2nd Half (Current)
                                            </button>
                                            <button 
                                                ...
                                                @click="setPreviousMonthFirstHalf"
                                            >
                                                1st Half (Previous)
                                            </button>
                                            <button 
                                                ...
                                                @click="setPreviousMonthSecondHalf"
                                            >
                                                2nd Half (Previous)
                                            </button>
                                        </div>
                                    ...
                                    <div v-if="workingDays > 0" class="bg-blue-100 p-3 rounded-lg">
                                        ...
                                        <div class="mt-2 text-sm text-blue-700">
                                            <span class="font-medium">Period:</span> {{ formatDateRange(form.start_date, form.end_date) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">
                                        <i class="bx bx-info-circle mr-1"></i>
                                        Enter the monthly basic salary (will be divided by 2 for half-month)
                                    </p>
                                </div>
                            ...
                            <div class="bg-blue-50 p-4 rounded-lg">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                    <div class="text-center p-3 bg-white rounded-lg shadow">
                                        <h6 class="text-gray-600 mb-1">Basic Salary</h6>
                                        <h4 class="text-blue-600 font-bold">₱{{ formatNumber(basicSalary) }}</h4>
                                        <p class="text-sm text-gray-500">Monthly</p>
                                    </div>
                                    <div class="text-center p-3 bg-white rounded-lg shadow">
                                        <h6 class="text-gray-600 mb-1">Gross Salary</h6>
                                        <h4 class="text-green-600 font-bold">₱{{ formatNumber(grossSalary) }}</h4>
                                        <p class="text-sm text-gray-500">Half Month</p>
                                    </div>
                                    <div class="text-center p-3 bg-white rounded-lg shadow">
                                        <h6 class="text-gray-600 mb-1">Overtime Pay</h6>
                                        <h4 class="text-yellow-600 font-bold">₱{{ formatNumber(overtimePay) }}</h4>
                                        <p class="text-sm text-gray-500">1.25x Rate</p>
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <!-- Notes -->
                            <div>
                                <InputLabel for="notes" value="Additional Notes (Optional)" class="flex items-center">
                                ...
                                <textarea
                                    ...
                                    placeholder="Enter any additional notes or comments about this payroll record..."
                                ></textarea>
                                <InputError :message="form.errors.notes" class="mt-2" />
                                <p class="mt-1 text-sm text-gray-500">
                                    <i class="bx bx-info-circle mr-1"></i>
                                    Add any special notes, explanations, or comments for this payroll record
                                </p>
                            </div>
                            ...
                            <div class="flex items-center justify-between pt-6">
                                ...
                                <div class="flex space-x-3">
                                    ...
                                    >
                                        ...
                                        {{ form.processing ? 'Creating...' : 'Create Payroll Record' }}
                                    </PrimaryButton>
                                </div>
                            </div>
                        </form>
...
const isFormValid = computed(() => {
    return form.user_id && form.start_date && form.end_date && form.period && form.basic_salary
})

// Methods
const onEmployeeChange = () => {
    selectedEmployee.value = props.employees.find(emp => emp.id == form.user_id)
}
...
const setCurrentMonthFirstHalf = () => {
    const now = new Date()
    const firstDay = new Date(now.getFullYear(), now.getMonth(), 1)
    const fifteenthDay = new Date(now.getFullYear(), now.getMonth(), 15)
    
    form.start_date = formatDateForInput(firstDay)
    form.end_date = formatDateForInput(fifteenthDay)
    form.period = '1st Half'
    calculateWorkingDays()
}

const setCurrentMonthSecondHalf = () => {
    const now = new Date()
    const sixteenthDay = new Date(now.getFullYear(), now.getMonth(), 16)
    const lastDay = new Date(now.getFullYear(), now.getMonth() + 1, 0)
    
    form.start_date = formatDateForInput(sixteenthDay)
    form.end_date = formatDateForInput(lastDay)
    form.period = '2nd Half'
    calculateWorkingDays()
}

const setPreviousMonthFirstHalf = () => {
    const now = new Date()
    const firstDay = new Date(now.getFullYear(), now.getMonth() - 1, 1)
    const fifteenthDay = new Date(now.getFullYear(), now.getMonth() - 1, 15)
...
const setPreviousMonthSecondHalf = () => {
    const now = new Date()
    const sixteenthDay = new Date(now.getFullYear(), now.getMonth() - 1, 16)
...
const previewPayroll = () => {
    ...
    const summary = `
Payroll Preview:
Employee: ${selectedEmployee.value?.name || 'Not selected'}
